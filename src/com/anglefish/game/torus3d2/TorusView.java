                    ...
                    if (GlobalVars.HELP && game.dropPositions[3] > TOP + 101) {
                        ...
                        if (boxId < 4) {
                            ...
                            if (boxId == 1) {
                                ...
                                tip = "Turn the torus3d2 to left or right with your gesture.";
                            }
                            boxPosY += 10;
...
//                        yPos + 0.5f * (facebookBmp.getHeight() + fontHeight), paint);
    ...
    void goWelcome() {
        Intent intent = new Intent(torusAct, com.anglefish.game.torus3d2.WelcomeAct.class);
        ;
    ...
    void help() {
        ...
        SharedPreferences sp = torusAct.getSharedPreferences(
                "com.anglefish.game.torus3d2_preferences",
