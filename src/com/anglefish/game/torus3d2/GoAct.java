package com.anglefish.game.torus3d2;
...
public class GoAct extends Activity /* implements AdListener */ {
    ...
    void goGames(int mode) {
        ...
        startGame.putExtra("com.anglefish.game.torus3d2.Mode", mode);
    ...
    public class GoView extends SurfaceView implements OnGestureListener,
        ...
        public GoView(Context context, AttributeSet attrs) {
            ...
            backgroundBmp = BitmapFactory.decodeResource(
                    context.getResources(), R.drawable.timerbackground);
        ...
        void drawFrame() {
            ...
            if (canvas != null) {
                ...
                canvas.drawBitmap(timetitleBmp, xPos + hL
                        + gotraditionalBmp.getWidth(), yPos + hL, paint);
                String content = GlobalVars.getHelpContent("time.txt",
                        GoAct.this);
                ...
                canvas.drawBitmap(traditionaltitleBmp,
                        ...
                        paint);
                content = GlobalVars.getHelpContent("traditional.txt", GoAct.this);
                    ...
                    .setPositiveButton(R.string.alertyes,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                                    int whichButton) {
                                    Uri uri = Uri
                                            .parse("market://details?id=com.anglefish.game.torus3dpro");
